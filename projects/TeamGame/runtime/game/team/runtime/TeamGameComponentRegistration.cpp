...
namespace Unnamed {
	...
	void RegisterTeamGameComponents(ComponentRegistry& componentRegistry) {
		...
		RegisterComponentIfMissing<MyGame::PlayerMoveComponent>(
			componentRegistry, "mygame.PlayerMoveComponent",
			"Player Move Component"
		);
		RegisterComponentIfMissing<MyGame::PlayerControlComponent>(
			componentRegistry, "mygame.PlayerControlComponent",
		...
		RegisterComponentIfMissing<MyGame::GolfBallStartPosComponent>(
			componentRegistry, "mygame.GolfBallStartPos",
			"Golf Ball Start Position"
		);
		...
		RegisterComponentIfMissing<MyGame::PlayerHoleComponent>(
			componentRegistry, "mygame.PlayerHoleComponent",
			"Player Hole Component"
		);
		...
		RegisterComponentIfMissing<MyGame::GolfBallUiComponent>(
			componentRegistry, "mygame.GolfBallUiComponent",
			"Golf Ball Ui Component"
		);
		...
		RegisterComponentIfMissing<GamePause>(
			componentRegistry, "mygame.GamePause", "GamePause"
		);
	}
}
