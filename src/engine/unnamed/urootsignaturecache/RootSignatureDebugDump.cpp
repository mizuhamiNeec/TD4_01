...
namespace Unnamed {
	...
	/// @param tag タグ文字列
	/// @return 妥当ならtrueを返す
	static bool ValidateDescAndLog(
	...
	void DumpRootSignatureDesc(
		...
		DevMsg(
			kChannel, "--- {} --- Params={}, Samplers={}, Flags=0x{:08x}",
		...
		for (UINT i = 0; i < d.NumParameters; ++i) {
			...
			switch (p.ParameterType) {
				...
				default:
					DevMsg(
						kChannel, " #{}: (Unknown root parameter type {})", i,
