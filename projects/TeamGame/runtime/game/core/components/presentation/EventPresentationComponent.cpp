...
namespace Unnamed {
	...
	AudioFxControllerComponent* EventPresentationComponent::ResolveAudioFx() const {
	...
	CameraFxControllerComponent* EventPresentationComponent::ResolveCameraFx() const {
	...
	SkeletalAnimationComponent* EventPresentationComponent::ResolveAnimation() const {
