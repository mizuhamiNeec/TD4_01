...
namespace Unnamed {
	void EditorRuntime::DrawViewportGizmo(
	...
	void EditorRuntime::DrawViewportTopBar() {
	...
	void EditorRuntime::DrawViewport(const float deltaTime) {
	...
	void EditorRuntime::DrawViewportOverlay(const float deltaTime) {
